    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto max-w-6xl">
        <div className="@container">
          <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-8 items-center @lg:gap-12">
            <div className="@container/hero space-y-4 @md/hero:space-y-6">
              <h1 className="text-4xl font-bold tracking-tight @md/hero:text-5xl @lg/hero:text-7xl">
                {profile.firstName}{" "}
              ...
              profile.headlineAnimatedWords.length > 0 ? (
                ...
                <p className="text-xl text-muted-foreground font-medium @md/hero:text-2xl @lg/hero:text-3xl">
                  {profile.headline}
                </p>
              )}
              ...
              {profile.socialLinks && (
                <div className="flex flex-wrap gap-3 pt-4 @md/hero:gap-4">
